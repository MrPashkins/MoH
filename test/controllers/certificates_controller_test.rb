...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post certificates_url, params: { certificate: { certificate_name: @certificate.certificate_name, description: @certificate.description } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { certificate_name: @certificate.certificate_name, description: @certificate.description } }
